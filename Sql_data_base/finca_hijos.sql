...
CREATE TABLE `hijos` (
  `hijosId` int(11) NOT NULL,
  `animalId` int(11) NOT NULL,
  PRIMARY KEY (`hijosId`,`animalId`),
  KEY `fk_Hijos_Animal1_idx` (`animalId`),
  CONSTRAINT `fk_Hijos_Animal1` FOREIGN KEY (`animalId`) REFERENCES `animal` (`animalId`)
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `aumentoAnimalesHijos` AFTER INSERT ON `hijos` FOR EACH ROW begin	
